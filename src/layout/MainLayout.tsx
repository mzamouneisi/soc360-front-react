...
export function MainLayout() {
  ...
  const _LAST_COMMIT_ = '2026_09_22_16_42_42'
  ...
  if (isAdmin) {
    sections.push({
      ...
      items: [
        ...
        { to: '/langues', label: t('nav.languages'), icon: ICONS.languages },
